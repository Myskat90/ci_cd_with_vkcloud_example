...
run_command "ansible-playbook main.yml -i 'localhost' -e github_owner=$github_owner -e github_repo=$github_repo -e github_authtoken=$github_token -e regru_authtoken=$regru_token -v" "ansible-k8s"
